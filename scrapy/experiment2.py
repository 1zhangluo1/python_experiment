...
def init_scrapy():
    ...
    _new_rank = AiqiyiSpider(rank_name='上新榜', route='/ranks1/1/-5', headers=headers)
    _high_score_rank = AiqiyiSpider(rank_name='高分榜', route='/ranks1/1/-4', headers=headers)
    return _heat_rank, _speed_rank, _must_watch_rank, _new_rank, _high_score_rank


if __name__ == '__main__':
    heat_rank, speed_rank, must_watch_rank, new_rank, high_score_rank = init_scrapy()
    spiders = [heat_rank, speed_rank, must_watch_rank, new_rank, high_score_rank]
